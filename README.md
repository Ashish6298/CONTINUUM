...
<table>
  <tr>
    ...
    <td align="center"><a href="tests/"><img src="https://img.shields.io/badge/Tests-156%2F156_Passed-00C853?style=plastic&logo=checkmarx&logoColor=white" alt="Tests Passed"/></a></td>
  </tr>
  <tr>
...
```bash
$ py tests/run_all_tests.py    # 156/156 Passed (100% Test Coverage across 29 Phases)
```
