...
<table>
  <tr>
    ...
    <td align="center"><a href="tests/"><img src="https://img.shields.io/badge/Tests-131%2F131_Passed-00C853?style=plastic&logo=checkmarx&logoColor=white" alt="Tests Passed"/></a></td>
  </tr>
  <tr>
...
```bash
$ py tests/run_all_tests.py    # 131/131 Passed (100% Test Coverage across 25 Phases)
```
